  ...
  <div class="content-in">
    ...
    <h4 class="result-flag">512 results</h4>
      <div class="table-list country-table">
         <?php
    $sel="select * from tbl_postal_address 
    LEFT JOIN states ON tbl_postal_address.state_id = states.state_id  
    LEFT JOIN countries ON tbl_postal_address.country_id = countries.country_id
    GROUP BY  tbl_postal_address.postal_id
   ";
	...
	if(mysqli_num_rows($result) > 0)
        ...
        <div class="table-row">
          ...
          <div class="country-name">
           <div><?php echo  $row['eng_postal_name']?></div>
          ...
          <div class="row-list" >
           <ul>
                          <li><img src="images/icon19.png"><span><?php echo $row['postal_id'];?></span></li>
