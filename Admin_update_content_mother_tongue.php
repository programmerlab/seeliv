  ...
  <div class="content-in">
    ...
    <h4 class="result-flag">512 results</h4>
      ...
      <div class="table-list country-table">
          <?php
    $sel="select * from tbl_mother_tongue 
    LEFT JOIN countries ON tbl_mother_tongue.country_id = countries.country_id
    GROUP BY  tbl_mother_tongue.mother_tongue_id";
	...
	if(mysqli_num_rows($result) > 0)
        ...
        <div class="table-row">
          ...
          <div class="country-name">
           <div><?php echo  $row['eng_mother_tongue_name']?></div>
          ...
          <div class="cnt-btom tog-expand">
            <div class="row-list" >
                                <ul>
                                   <li><img src="images/icon19.png"><span><?php echo $row['mother_tongue_id'];?></span></li>
