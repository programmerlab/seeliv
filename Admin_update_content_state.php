  ...
  <div class="content-in">
    ...
    <h4 class="result-flag">512 results</h4>
      <div class="table-list country-table">
          <?php
    $sel="select * from countries LEFT JOIN states ON countries.country_id = states.country_id";
	...
	if(mysqli_num_rows($result) > 0)
	{
        ...
        <div class="table-row">
          ...
          <div class="country-name">
           <div><?php echo  $row['eng_state_name']?></div>
          ...
          <div class="cnt-btom tog-expand">
           ...
           <ul>
                                                   ...
                                                   <li><img src="images/icon19.png"><span><?php echo  $row['state_id']?></span></li>
