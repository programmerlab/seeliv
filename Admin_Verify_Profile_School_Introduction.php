...
<title>Verify School Introduction</title>
...
<!--                                <li><a href="#"><span class="fa-li"><i class="fas fa-camera-retro"></i></span>Display Picture (dp)</a></li>-->
...
<!--  </div>-->
<!--</section>-->
<!--<?php include("includes/Admin_update_profile_window_one.php"); ?>-->
<div class="content">
