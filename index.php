...
<div class="top-log">
  ...
  <div class="log-pg-hds">Admin login</div>
...
<?php
	    $auth=md5((time().rand(00000,99999)));
	    $_SESSION['auth']=$auth;
	?>
<form method="post" action="action/do_admin_login.php?action=Do_login_mob">
...
<div class="login-form">
  ...
  <div class="bottom-log">
    ...
    <div class="field for-email-mod">
       <input type="text"  name="email" placeholder="Email / Account ID / Approval ID"  />
    </div>
    <div class="field">
 ...
 <?php if(isset($_REQUEST['msg']) && $_REQUEST['msg']=='invalid'){
			?>
			<p style="color:red;" class="text-center text-danger"><b>Error! Invalid Login detail. Try Again...</b></p>
			<?php
	}?>
</from> 
